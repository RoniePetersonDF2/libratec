    ...
    <section class="cards_selecao">
        ...
        <div class="cards">
            <div class="card-item-opcao">
                <div class="nomecard">
                    <a href="usuario_admin_list_surdo.php" class="tirardecoracao">
                        <p><b>SURDO</b></p>
                        <br><br><br>
            ...
            <div class="card-item-opcao">
                <div class="nomecard">
                    <a href="usuario_admin_list_interprete.php" class="tirardecoracao">
                        <p><b>INTÉRPRETE</b></p>
                        <br><br><br>
            ...
            <div class="card-item-opcao">
                <div class="nomecard">
                    <a href="usuario_admin_list_empresa.php" class="tirardecoracao">
                        <p><b>EMPRESA</b></p>
                        <br><br><br>
